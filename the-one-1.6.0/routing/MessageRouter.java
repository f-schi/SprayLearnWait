...
public abstract class MessageRouter {
	...
	/**
	 * F-Schi
	 * runningAvgWeight Project Router Settings Parameter used in DTNHost running Average Calcs
	 * @return
	 */
	...
	protected Double runningAvgWeight;
	...
	protected int compareByQueueMode(Message m1, Message m2) {
		...
		case Q_MODE_RANDOM:
			...
			/**
			 * F-Schi
			 * Release 1.6.0 Implementation:
			 * return (m1.hashCode()/2 + m2.hashCode()/2) % 3 - 1;
			 *
			 *
			 * Master Branch 2023 Implementation
			 * I needed to switch out this part of the code, as the legacy implementation
